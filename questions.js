const quizQuestions = {
  ...
  "questions": [
    ...
    {
      "question": "You just installed the Google Cloud CLIaa on your new corporate laptop. You need to list the existing instances of your company on Google Cloud. What must you do before you run the gcloud compute instances list command? (Choose two.)​",
      "options": {
